            ...
            <div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 py-4 px-6 bg-safety text-white rounded-xl font-bold hover:bg-safety/90 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 inline-flex items-center justify-center gap-2 py-4 px-6 bg-white border-2 border-clinical-200 text-clinical-800 rounded-xl font-bold hover:bg-clinical-50 transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
